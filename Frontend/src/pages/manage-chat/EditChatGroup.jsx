...
const EditChatGroup = (props) => {
    ...
    return (
        ...
        <Dialog 
            ...
            keepMounted
        >
            <DialogTitle className='heading' style={{marginLeft:'200px',color:'#707070'}}>Edit Chat Group</DialogTitle>
            <DialogContent>
            ...
            <DialogActions>
            <Button style={{color:'#000'}} onClick={() => props.setEditOpen(false)}>Cancel</Button>
